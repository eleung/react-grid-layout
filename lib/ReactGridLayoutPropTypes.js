...
export type Props = {|
  ...
  crossGridAcceptsDrop?: boolean | ((item: LayoutItem, sourceGridId: string) => boolean),
  crossGridTransform?: (item: LayoutItem, sourceConfig: any, targetConfig: any) => LayoutItem,
...
export default {
  ...
  crossGridTransform: PropTypes.func,
