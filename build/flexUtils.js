...
exports.cloneFlexLayout = cloneFlexLayout;
exports.cloneFlexLayoutItem = cloneFlexLayoutItem;
exports.fastFlexPropsEqual = fastFlexPropsEqual;
exports.flexLayoutsEqual = flexLayoutsEqual;
exports.getFlexLayoutItem = getFlexLayoutItem;
exports.getFlexStatics = getFlexStatics;
exports.noop = noop;
exports.normalizeFlexLayout = normalizeFlexLayout;
exports.sortFlexLayoutItemsByOrder = sortFlexLayoutItemsByOrder;
exports.synchronizeFlexLayoutWithChildren = synchronizeFlexLayoutWithChildren;
exports.validateFlexLayout = validateFlexLayout;
exports.withFlexLayoutItem = withFlexLayoutItem;
 ...
 */
function bottom(layout /*: FlexLayout*/) /*: number*/{
  let max = 0;
 ...
 */
function cloneFlexLayoutItem(layoutItem /*: FlexLayoutItem*/) /*: FlexLayoutItem*/{
  return {
    i: layoutItem.i,
 ...
 * Clone a flex layout.
 */
function cloneFlexLayout(layout /*: FlexLayout*/) /*: FlexLayout*/{
 ...
 */
function getFlexLayoutItem(layout /*: FlexLayout*/, id /*: string*/) /*: ?FlexLayoutItem*/{
  for (let i = 0, len = layout.length; i < len; i++) {
 ...
 */
function validateFlexLayout(layout /*: FlexLayout*/) /*: void*/{
  let contextName /*: string*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "FlexLayout";
  ...
  for (let i = 0, len = layout.length; i < len; i++) {
    ...
    for (let j = 0; j < subProps.length; j++) {
      if (item[subProps[j]] === undefined) {
        throw new Error("FlexLayout item at index " + i + ' is missing required property "' + subProps[j] + '"');
      }
    }
  }
}
 ...
 */
function flexLayoutsEqual(a /*: FlexLayout*/, b /*: FlexLayout*/) /*: boolean*/{
  return (0, _fastEquals.deepEqual)(a, b);
}

/**
 * Given a layout, make sure all elements fit within the constraints.
 */
function normalizeFlexLayout(layout /*: FlexLayout*/) /*: FlexLayout*/{
 ...
 */
function sortFlexLayoutItemsByOrder(layout /*: FlexLayout*/) /*: FlexLayout*/{
 ...
 */
function synchronizeFlexLayoutWithChildren(layout /*: FlexLayout*/, children /*: ReactChildrenArray<ReactElement<any>>*/, cols /*: number*/) /*: FlexLayout*/{
  ...
  _react.default.Children.forEach(children, (child /*: ReactElement<any>*/, i /*: number*/) => {
    ...
    if (exists) {
      ...
      if (!isProduction && child.props._grid) {
        console.warn("`_grid` properties on children have been deprecated as of React 15.2. " + "Please use `data-flex` or add items to the `layout` prop.");
      }
 ...
 */
function getFlexStatics(layout /*: FlexLayout*/) /*: Array<FlexLayoutItem>*/{
 ...
 */
function fastFlexPropsEqual(a /*: Object*/, b /*: Object*/) /*: boolean*/{
  // Fast check for common immutable props
  if (a.width !== b.width || a.direction !== b.direction || a.justifyContent !== b.justifyContent || a.alignItems !== b.alignItems || a.gap !== b.gap || a.isDraggable !== b.isDraggable || a.isDroppable !== b.isDroppable || a.isBounded !== b.isBounded || a.transformScale !== b.transformScale || a.className !== b.className || a.style !== b.style) {
    return false;
  }
 ...
 */
function withFlexLayoutItem(layout /*: FlexLayout*/, itemKey /*: string*/, cb /*: (item: FlexLayoutItem) => FlexLayoutItem*/) /*: [FlexLayout, ?FlexLayoutItem]*/{
