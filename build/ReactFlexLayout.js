...
var _ReactFlexLayoutPropTypes = _interopRequireDefault(require("./ReactFlexLayoutPropTypes"));
 ...
 */
class ReactFlexLayout extends React.Component /*:: <Props, State>*/{
  constructor() {
    super(...arguments);
    _defineProperty(this, "context", void 0);
    _defineProperty(this, "state", {
      activeDrag: null,
      layout: (0, _flexUtils.synchronizeFlexLayoutWithChildren)(this.props.layout, this.props.children, 12 // Not used for flex, but keep for compatibility
      ),
      mounted: false,
      oldDragItem: null,
      oldLayout: null,
    ...
    _defineProperty(this, "flexRef", /*#__PURE__*/React.createRef());
    // Store item bounds during drag for collision detection and reordering
    _defineProperty(this, "itemBounds", new Map());
    // Store original order before drag for diff calculation
    _defineProperty(this, "originalOrder", []);
    ...
    _defineProperty(this, "pendingExternalMousePosition", null);
    /**
     * Helper: Schedule re-enabling transitions after a brief delay
     */
    _defineProperty(this, "scheduleReEnableTransitions", () => /*: void*/{
     ...
     */
    _defineProperty(this, "scheduleCollectBounds", () => /*: void*/{
     ...
     */
    _defineProperty(this, "updateDropTargetConfigIfNeeded", (prevProps /*: Props*/) => /*: void*/{
      if (!this.props.enableCrossGridDrag || !this.context || !this.props.id) return;
      if (prevProps.direction !== this.props.direction || prevProps.gap !== this.props.gap || prevProps.crossGridAcceptsDrop !== this.props.crossGridAcceptsDrop) {
     ...
     */
    _defineProperty(this, "handleExternalDragIfActive", () => /*: void*/{
     ...
     */
    _defineProperty(this, "collectBoundsIfExternalItemAdded", (prevState /*: State*/) => /*: void*/{
      ...
      if (currentExternalItem && !prevExternalItem || currentExternalItem && prevExternalItem && currentExternalItem.i !== prevExternalItem.i) {
        requestAnimationFrame(() => {
          requestAnimationFrame(() => {
            ...
            if (this.pendingExternalMousePosition && currentExternalItem) {
              const {
                mouseX,
                mouseY
              } = this.pendingExternalMousePosition;
     ...
     */
    _defineProperty(this, "finalizeExternalDropIfDragEnded", (prevState /*: State*/) => /*: void*/{
     ...
     */
    _defineProperty(this, "findItemAtPosition", (mouseX /*: number*/, mouseY /*: number*/) => /*: ?string*/{
      const {
        direction,
        gap
      } = this.props;
      ...
      for (const [itemId, rect] of this.itemBounds.entries()) {
        ...
        const isColliding = isHorizontal ? mouseX >= left && mouseX <= right : mouseY >= top && mouseY <= bottom;
        if (isColliding) {
          // Calculate distance to item center to handle overlapping zones
          const centerX = rect.left + rect.width / 2;
          const centerY = rect.top + rect.height / 2;
          const distance = isHorizontal ? Math.abs(mouseX - centerX) : Math.abs(mouseY - centerY);
    ...
    _defineProperty(this, "getAcceptsDrop", () => /*: boolean | ((item: FlexLayoutItem, sourceId: string) => boolean)*/{
      const {
     ...
     */
    _defineProperty(this, "clearExternalDragState", () => /*: void*/{
     ...
     */
    _defineProperty(this, "onItemRemovedFromFlex", (itemId /*: string*/) => /*: void*/{
     ...
     */
    _defineProperty(this, "calculateInsertIndex", (mouseX /*: number*/, mouseY /*: number*/) => /*: number*/{
      ...
      if (isHorizontal) {
        ...
        return mouseX > closestRect.left + closestRect.width / 2 ? closestIndex + 1 : closestIndex;
      } else {
        // If mouse is below center, insert after
        return mouseY > closestRect.top + closestRect.height / 2 ? closestIndex + 1 : closestIndex;
      }
    });
    /**
     * Renumber layout item orders after inserting at a specific index
     */
    _defineProperty(this, "renumberOrders", (layout /*: FlexLayout*/) => /*: FlexLayout*/{
      const {
        direction
      } = this.props;
      const isReversed = direction === 'row-reverse' || direction === 'column-reverse';
      return (0, _flexUtils.sortFlexLayoutItemsByOrder)(layout).map((item, index) => {
     ...
     */
    _defineProperty(this, "isMouseOverContainer", (mouseX /*: number*/, mouseY /*: number*/) => /*: boolean*/{
     ...
     */
    _defineProperty(this, "transformDraggedItem", (dragState /*: any*/) => /*: FlexLayoutItem*/{
     ...
     */
    _defineProperty(this, "addExternalItemToLayout", (transformedItem /*: FlexLayoutItem*/, mouseX /*: number*/, mouseY /*: number*/) => /*: void*/{
      // Save original layout (filter out any existing external items)
      const oldLayout = this.state.oldLayout || this.state.layout.filter(item => !item.i.startsWith("__external__"));
      const externalId = `__external__${transformedItem.i}`;
      const externalItem /*: FlexLayoutItem*/ = {
        i: externalId,
        order: this.state.layout.length,
        // Append to end to avoid order conflicts
     ...
     */
    _defineProperty(this, "updateExternalItemPosition", (externalId /*: string*/, mouseX /*: number*/, mouseY /*: number*/) => /*: void*/{
     ...
     */
    _defineProperty(this, "calculateInitialOrderForExternalItem", (mouseX /*: number*/, mouseY /*: number*/) => /*: number*/{
    ...
    _defineProperty(this, "handleExternalDrop", () => /*: void*/{
      ...
      if (currentOrder && currentOrder.length > 0) {
        ...
        newLayout = (0, _flexUtils.sortFlexLayoutItemsByOrder)(newLayout);
      } else {
     ...
     */
    _defineProperty(this, "collectItemBounds", () => {
     ...
     */
    _defineProperty(this, "updateItemSizes", () => {
      ...
      items.forEach((item /*: HTMLElement*/) => {
        ...
        if (itemId) {
          ...
          if (existingBounds) {
            ...
            const updatedBounds = new DOMRect(existingBounds.x,
            // Keep original position
            existingBounds.y,
            // Keep original position
            currentWidth,
            // Update width (changes due to flex-shrink)
     ...
     */
    _defineProperty(this, "onDragStart", (i /*: string*/, order /*: number*/, eventData /*: Object*/) => {
      const {
        onDragStart
      } = this.props;
      const l = (0, _flexUtils.getFlexLayoutItem)(this.state.layout, i);
      if (!l) return;
      this.collectItemBounds();
      const placeholder = {
        ...l,
     ...
     */
    _defineProperty(this, "calculateNewOrder", (draggedId /*: string*/, mouseX /*: number*/, mouseY /*: number*/) => /*: ?Array<string>*/{
      const {
        direction,
        gap
      } = this.props;
     ...
     */
    _defineProperty(this, "calculateTransforms", (draggedId /*: string*/, newOrder /*: Array<string>*/, draggedRect /*: DOMRect*/) => /*: Map<string, {x: number, y: number}>*/{
      ...
      if (oldDraggedIndex !== -1 && newDraggedIndex !== -1 && oldDraggedIndex !== newDraggedIndex) {
        ...
        transforms.set('__placeholder__', {
          x: 0,
          y: 0
        });
      }
      ...
      this.originalOrder.forEach((id, oldIndex) => {
        ...
        if (indexDiff !== 0) {
          ...
          transforms.set(id, isHorizontal ? {
            x: offset,
            y: 0
          } : {
            x: 0,
     ...
     */
    _defineProperty(this, "onDrag", (i /*: string*/, order /*: number*/, eventData /*: Object*/) => {
      const {
        onDrag
      } = this.props;
      const l = (0, _flexUtils.getFlexLayoutItem)(this.state.layout, i);
      ...
      if (this.itemBounds.size > 0 && newPosition && e) {
        ...
        // Preserves original positions to avoid capturing transformed positions.
        this.updateItemSizes();
        const draggedRect = new DOMRect(newPosition.left, newPosition.top, newPosition.width, newPosition.height);
        ...
        if (shouldCollapseItem) {
          layoutForCalculation = this.state.layout.map(item => item.i === i ? {
            ...item,
            grow: 0,
            shrink: 1,
            maxWidth: 0,
        ...
        let newOrder = shouldCollapseItem ? this.originalOrder // Keep original order when collapsed
        ...
        const finalLayout = layoutForCalculation.map(item => item.i === i ? {
          ...item,
          grow: draggedGrow,
          shrink: draggedShrink,
          maxWidth: oldDragItem?.maxWidth,
          maxHeight: oldDragItem?.maxHeight
        } : item);

        // Determine if this flex is the drag source for CSS class application
        const isSourceFlex = this.props.enableCrossGridDrag && this.context?.dragState && this.context.dragState.sourceId === this.props.id;
     ...
     */
    _defineProperty(this, "onDragStop", (i /*: string*/, order /*: number*/, eventData /*: Object*/) => {
      const {
        onDragStop
      } = this.props;
      const l = (0, _flexUtils.getFlexLayoutItem)(this.state.layout, i);
  ...
  componentDidMount() {
    ...
    if (this.props.enableCrossGridDrag && this.context && this.props.id && this.flexRef.current) {
      this.context.registerDropTarget(this.props.id, this.flexRef.current, 'flex', {
        direction: this.props.direction,
        gap: this.props.gap,
        containerHeight: this.getContainerHeight(),
        acceptsDrop: this.getAcceptsDrop(),
  ...
  static getDerivedStateFromProps(nextProps /*: Props*/, prevState /*: State*/) /*: $Shape<State> | null*/{
    ...
    if (!(0, _fastEquals.deepEqual)(nextProps.layout, prevState.propsLayout)) {
      newLayoutBase = nextProps.layout;
    } else if (!(0, _flexUtils.childrenEqual)(nextProps.children, prevState.children)) {
    ...
    if (newLayoutBase) {
      const newLayout = (0, _flexUtils.synchronizeFlexLayoutWithChildren)(newLayoutBase, nextProps.children, 12);
      return {
        layout: newLayout,
  ...
  shouldComponentUpdate(nextProps /*: Props*/, nextState /*: State*/) /*: boolean*/{
    return this.props.children !== nextProps.children || !(0, _fastEquals.deepEqual)(this.props, nextProps) || this.state.activeDrag !== nextState.activeDrag || this.state.mounted !== nextState.mounted || this.state.transforms !== nextState.transforms ||
    // Check if transforms Map changed
    this.state.disableTransitions !== nextState.disableTransitions || this.state.isDropActive !== nextState.isDropActive || this.state.isDropSource !== nextState.isDropSource;
  }
   ...
   */
  onLayoutMaybeChanged(newLayout /*: FlexLayout*/, oldLayout /*: ?FlexLayout*/) /*: void*/{
  ...
  renderExternalItem() /*: ?ReactElement<any>*/{
    ...
    const syntheticChild = this.props.renderDroppingItem ? /*#__PURE__*/React.cloneElement(this.props.renderDroppingItem(externalItem), {
      key: externalItem.i
  ...
  renderExternalPlaceholder() /*: ?ReactElement<any>*/{
    ...
    const transition = this.state.disableTransitions ? 'none' : 'left 200ms ease, top 200ms ease, width 100ms ease, height 100ms ease';
   ...
   */
  processFlexItem(child /*: ReactElement<any>*/, isDraggable /*: boolean*/) /*: ?ReactElement<any>*/{
    if (!child || !child.key) return null;
    const l = (0, _flexUtils.getFlexLayoutItem)(this.state.layout, String(child.key));
    if (!l) return null;
    const {
      gap,
      draggableHandle,
    ...
    const transform = isExternalPlaceholder ? {
      x: 0,
      y: 0
    } : this.state.transforms.get(l.i) || {
      x: 0,
      y: 0
    };

    // Get placeholder transform (where the dragged item will land)
    const placeholderTransform = this.state.transforms.get('__placeholder__') || {
      x: 0,
      y: 0
    };
    ...
    return /*#__PURE__*/React.createElement(_FlexItem.default, {
      key: child.key,
      i: l.i,
      order: l.order,
      grow: l.grow,
  ...
  render() /*: ReactElement<"div">*/{
    ...
    const mergedStyle = {
      ...
      gap: `${gap}px`,
      position: 'relative',
      // For absolute positioning of external placeholder
      ...style
    };
    return /*#__PURE__*/React.createElement("div", {
      ref: this.flexRef,
      ...
      style: mergedStyle
    }, React.Children.map(this.props.children, (child /*: ReactElement<any>*/) => this.processFlexItem(child, this.props.isDraggable)), this.renderExternalItem(), this.renderExternalPlaceholder());
  }
}
exports.default = ReactFlexLayout;
_defineProperty(ReactFlexLayout, "displayName", "ReactFlexLayout");
_defineProperty(ReactFlexLayout, "propTypes", _ReactFlexLayoutPropTypes.default);
// Context for drag and drop (flex layouts, grids, and external containers)
_defineProperty(ReactFlexLayout, "contextType", _DragDropContext.default);
_defineProperty(ReactFlexLayout, "defaultProps", {
  className: "",
  style: {},
  draggableHandle: "",
  draggableCancel: "",
  ...
  transformScale: 1,
  onLayoutChange: _flexUtils.noop,
  onDragStart: _flexUtils.noop,
  onDrag: _flexUtils.noop,
  onDragStop: _flexUtils.noop,
  onDrop: _flexUtils.noop,
