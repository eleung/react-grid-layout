...
/**
 * This example demonstrates ReactFlexLayout with dragging disabled.
 * Items are displayed in a flex layout but cannot be moved.
 */
export default class FlexNoDraggingLayout extends React.PureComponent {
  static defaultProps = {
    className: "layout",
    isDraggable: false,
    items: 12,
...
if (process.env.STATIC_EXAMPLES === true) {
  import("../test-hook.jsx").then(fn => fn.default(FlexNoDraggingLayout));
}
